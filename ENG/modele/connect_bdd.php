<?php
	...
	class bdd{
		...
		public function sortList(){
			...
			$req = "select distinct ue.codeUE, ue.libelleUE, ue.credits, ue.automne, ue.printemps from UE ue, informations_ue iue, enseignement en where ue.codeUE = iue.codeUE and en.codeUE = ue.codeUE and langue_bdd ='EN'" ;
