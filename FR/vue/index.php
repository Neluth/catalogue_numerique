...
<html>
	...
	<body>
		<header>
			<a href="index.php" id="activeLG">FR</a>
			<a href="../../eng/vue/index.php">EN</a>
		</header>

		<h1>Bienvenue sur le guide des enseignements de l'UTT</h1>

		<div class="page">
			<div id="filtres">
				<div id="rechForm">
				   	<input id="rechInput" type="text" name="recherche" placeholder="Rechercher...">
				...
				<div id="autresFiltres">
					<div class="filtreBloc" id="annees">
						<i class="far fa-calendar-alt"></i><label for="annee">Année universitaire</label>
					...
					<div class="filtreBloc" id="formations">
						<i class="fas fa-graduation-cap"></i><label for="formation">Formation</label>
					...
					<div class="filtreBloc" id="lgform">
						<i class="fas fa-language"></i><label for="langue">Langue(s) d'enseignement</label>
						<br/>
					...
					<div class="filtreBloc">
						<i class="fas fa-cloud-sun"></i><label for="semestre">Semestre(s)</label>
						<br/>
						<div id="semestre">
							<button type="button" class="btn-form" value="1">Automne</button><br/>
							<button type="button" class="btn-form" value="2">Printemps</button>
						</div>
					</div>

					<div class="filtreBloc" id="categForm">
						<i class="fas fa-shapes"></i><label for="categorie">Catégorie(s)</label>
						<br/>
						<div id="categorie">
